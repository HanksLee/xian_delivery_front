...
export default {
  ...
  methods: {
    ...
    async handleGetDistance() {
      ...
      const origins = `origins=${this.airportOptions[this.formData.airport_id].name}`;
      const destinations = `destinations=${this.tempLocations.join("|")}`;
